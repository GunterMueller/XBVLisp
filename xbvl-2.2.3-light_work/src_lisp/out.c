...
Int pannot(){/* impression annotations */
  /* a1=(Int*)prnxt=((Int)'{');rec(pvcch,pann1); */ /* GM */
  a1=prnxt=('{');rec(pvcch,pann1);
}
...
Int probc(){
  ...
  if(isatom(a3) && a3==quote && ANot==0)
    {pushf(probc33);push(a1);pushf(popa1);
     /* a1=(Int*)prnxt=((Int)'\'');pc=pvcch;return;} */ /* GM */
     a1=prnxt=('\'');pc=pvcch;return;}
  ...
  if(ANot!=0) {pop_cast(a3,(Int *));
	       ...
	       /* push(car(a1)); pushf(popa1);a1=(Int*)prnxt=((Int)'(');  */ /* GM */
	       push(car(a1)); pushf(popa1);a1=prnxt=('('); 
	       pc=pvcch;}
